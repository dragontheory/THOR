...
<body id="thor">____________________________________________________________:_____________________________________________________________________________________________
| <header>________________________________________________________________  :                                                                                             |
| |                                                                       | :                                                                                             |
| </header>_______________________________________________________________| :                                                                                             |
| <main>____________________________________________________________________:___________________________________________________________________________________________  |
| |                                                                         :                  <div>_______________(wrapper for resizer)_________________               | |
| | .home_________________________________________________________________  : .filter________  | .results______________________________  .profile______  | .details___  | |
| | |                                                                     | : |              | | |                                     | |             | | |          | | |
| | |    Welcome [ user.name ]                                            | : |              | | |                                     | |             | | |          | | |
| | |                                                                     | : |              | | |                                     | |             | | |          | | |
...
| | |_____________________________________________________________________| : |______________| | |_____________________________________| |_____________| | |__________| | |
| |                                                                         :                  </div>____________________________________________________|              | |
| </main>___________________________________________________________________:___________________________________________________________________________________________| |
| <footer>________________________________________________________________  :                                                                                             |
| |                                                                       | :                                                                                             |
| </footer>_______________________________________________________________| :                                                                                             |
</body>_____________________________________________________________________:_____________________________________________________________________________________________|
                                                                            :
                                                                            :
```
---
...
```
                                                                                :
                                                                  [ on screen ] : [ off screen ]
<body id="thor">________________________________________________________________:__________________________________
...
| <main>________________________________________________________________________:________________________________  |
| |                                   <div>_______________(wrapper for resizer)_:_________________               | |
| | .news__________  .filter________  | .results______________________________  : .profile______  | .details___  | |
| | |              | |              | | |                                     | : |             | | |          | | |
| | |              | |              | | |                                     | : |             | | |          | | |
| | |              | |              | | |                                     | : |             | | |          | | |
| | |              | |              | | |                                     | : |             | | |          | | |
...
| | |              | |              | | |                                     | : |             | | |          | | |
| | |              | |              | | |                                     | : |             | | |          | | |
| | |______________| |______________| | |_____________________________________| : |_____________| | |__________| | |
| |                                   </div>____________________________________:_________________|              | |
| </main>_______________________________________________________________________:________________________________| |
...
</body>_________________________________________________________________________:__________________________________|
                                                                                :
                                                                                :
```
---
