...
<body id="thor">____________________________________________________________:_________________________________________________________________________________________
| <header>________________________________________________________________  :                                                                                         |
| |                                                                       | :                                                                                         |
| </header>_______________________________________________________________| :                                                                                         |
| <main>____________________________________________________________________:_______________________________________________________________________________________  |
| |                                                                         :              <div>____________________(for resizer)____________________               | |
| | .home_________________________________________________________________  : .filter____  | .results______________________________  .profile______  | .details___  | |
| | |                                                                     | : |          | | |                                     | |             | | |          | | |
| | |    Welcome [ user.name ]                                            | : |          | | |                                     | |             | | |          | | |
| | |                                                                     | : |          | | |                                     | |             | | |          | | |
...
| | |_____________________________________________________________________| : |__________| | |_____________________________________| |_____________| | |__________| | |
| |                                                                         :              </div>____________________________________________________|              | |
| </main>___________________________________________________________________:_______________________________________________________________________________________| |
| <footer>________________________________________________________________  :                                                                                         |
| |                                                                       | :                                                                                         |
| </footer>_______________________________________________________________| :                                                                                         |
</body>_____________________________________________________________________:_________________________________________________________________________________________|
                                                                            :
                                                                            :
```
---
...
```
                                                                        :
                                                          [ on screen ] : [ off screen ]
<body id="thor">________________________________________________________:__________________________________
...
| <main>________________________________________________________________:________________________________  |
| |                           <div>____________________(for resizer)____:_________________               | |
| | .home______  .filter____  | .results______________________________  : .profile______  | .details___  | |
| | |          | |          | | |                                     | : |             | | |          | | |
| | |          | |          | | |                                     | : |             | | |          | | |
| | |          | |          | | |                                     | : |             | | |          | | |
| | |          | |          | | |                                     | : |             | | |          | | |
...
| | |          | |          | | |                                     | : |             | | |          | | |
| | |          | |          | | |                                     | : |             | | |          | | |
| | |__________| |__________| | |_____________________________________| : |_____________| | |__________| | |
| |                           </div>____________________________________:_________________|              | |
| </main>_______________________________________________________________:________________________________| |
...
</body>_________________________________________________________________:__________________________________|
                                                                        :
                                                                        :
```
---
